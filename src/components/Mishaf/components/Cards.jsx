...
const userData = {
  ...
  attendants: { total: 50 },
  admins: { total: 30, children: 150 },
};

// Component to render individual dashboard card
const DashboardCard = ({ title, Icon, stats }) => (
  <div className="bg-white shadow-lg rounded-lg p-1 h-full">
    <CardContent>
      <Box display="flex" flexDirection="column" alignItems="center" className="bg-violet-50 p-4 rounded-lg h-full">
        {/* Icon for the card */}
