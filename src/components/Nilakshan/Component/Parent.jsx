...
const Parent = () => {
  ...
  const handleChange = (e) => {
   ...
   try{
      ...
      const response = await axios.post('http://localhost:3000/backend/Login_php/login.php',
...
//react send to the email to php if php recived and that send response "suceess" 
      console.log('Response:', response);
      if (response.status === 200) {

        
        // Navigate to the '/parent' route after a successful response
